...
export const CLINE_ROO_RULES_VERSION = packageJson.version;

export const CLINE_ROO_RULES_TEMPLATE = `# Ask Gemini for help
...
<!-- vibe-tools-version: ${CLINE_ROO_RULES_VERSION} -->
`;
