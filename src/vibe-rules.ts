...
--with-doc=<doc_url>: Fetch content from one or more document URLs and include it as context for the question (e.g., \`vibe-tools ask "What does this spec require?" --with-doc=https://example.com/spec.pdf --with-doc=https://example.com/another-spec.md\`). **You can use this flag multiple times.**
...
--with-doc=<doc_url>: Fetch content from one or more document URLs and include it as context for both file identification and planning (e.g., \`vibe-tools plan "implement feature X following the spec" --with-doc=https://example.com/feature-spec --with-doc=https://example.com/design-notes.md\`). **You can use this flag multiple times.**
...
--with-doc=<doc_url>: Fetch content from one or more document URLs and include it as context. **Use the flag multiple times for multiple URLs.**
